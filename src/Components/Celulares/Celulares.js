...
console.log("Paso Correcto")
    ...
    ChangeModelo=()=>{
        ...
        if(!/^([a-zA-ZÁáÀàÉéÈèÍíÌìÓóÒòÚúÙùÑñüÜ]{2,15}(([ ][A-ZÁÀÉÈÍÌÓÒÚÙÑÜ]{2,15})([ ][A-ZÁÀÉÈÍÌÓÒÚÙÑÜ]{2,15})([ ][A-ZÁÀÉÈÍÌÓÒÚÙÑÜ]{2,15}))?)*/g.test(Modelo)){
...
if(Ensamblado.match("[A-ZÁáÀàÉéÈèÍíÌìÓóÒòÚúÙùÑñüÜ0 ]{2,50}")){
    if (Marca.match("([a-zA-ZÁáÀàÉéÈèÍíÌìÓóÒòÚúÙùÑñüÜ]{2,15}(([ ][A-ZÁÀÉÈÍÌÓÒÚÙÑÜ]{2,15})([ ][A-ZÁÀÉÈÍÌÓÒÚÙÑÜ]{2,15})([ ][A-ZÁÀÉÈÍÌÓÒÚÙÑÜ]{2,15}))?)")){
        if(Modelo.match("([A-ZÁÀÉÈÍÌÓÒÚÙÑÜ0-9]{2,15}([ ][A-ZÁÀÉÈÍÌÓÒÚÙÑÜ0-9]{2,15})?([ ][A-ZÁÀÉÈÍÌÓÒÚÙÑÜ0-9]{2,15})?)?)")){
